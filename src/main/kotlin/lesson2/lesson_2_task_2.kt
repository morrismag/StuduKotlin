...
fun main() {
    ...
    println(
        "Расходы на выплату заплаты постоянных сотрудников составляет:\n" +
                "$sumSalaryOldWorkers рублей"
    )
    println(
        "Общие расходы по зарплате после устройства стажеров составляет:\n" +
                "$sumSalaryAll рублей"
    )
    println(
        "Средняя зарплата сотрудника после устройства стажеров составила:\n" +
